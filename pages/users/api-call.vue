    ...
    <v-row>
      <v-col cols="auto" lg="12" md="12" sm="12" xs="12" class="api-column">
        <v-card class="card-style">
          <v-card-title class="label subtitle-1 mb-5 break-word">
            API ID & Key are for use by developers.
            <b>Do not share this information,</b> it gives the holder access to
            your Evercam account.
          </v-card-title>
          <v-card-text>
                  ...
                  <td class="col-8 caption">
                    ...
                    >
                      <template v-slot:selection="data">
                        <v-avatar left :tile="true" class="pr-3" height="35px">
                          <v-img
                            :src="
        ...
        <v-card class="card-style">
          <v-card-title class="label subtitle-1">
            API Documentation available here.<v-btn
              icon
              color="blue"
              x-small
              target="blank"
              href="https://media.evercam.io/v2/swagger/index.html"
            >
              <v-icon>fa fa-external-link-alt</v-icon>
            </v-btn>
          </v-card-title>
        </v-card>
      </v-col>
  ...
  methods: {
    ...
    onSelectRecordedCamera(data) {
      ...
      let date_time = moment
        .tz(this.api_datetime, data.timezone)
      ...
      this.$axios
        ...
        .catch(jqXHR => {
          ...
          this.urlToSnapshot =
            "There are no snapshots available for the selected period."
          this.urlToDash = `https://dash2.evercam.io/v2/cameras/${this.cameraData.id}/recordings/snapshots/${date_time}?api_id=${this.userApiId}&api_key=${this.userApiKey}`
        })
    }
  }
